...
%0Afind%20/%20-maxdepth%201%20-type%20f%20-name%20"*.txt"%20-print0

Command Explanation:

    find / -maxdepth 1 -type f -name "*.txt" -print0:
        find /: Searches from the root directory.
        -maxdepth 1: Limits the search to the top level of the directory.
        -type f: Finds files.
        -name "*.txt": Filters to .txt files.
        -print0: Outputs filenames separated by null characters, useful for handling filenames with spaces.
----
